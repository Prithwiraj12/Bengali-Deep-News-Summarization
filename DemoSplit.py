...
def main():
    ...
    # decode('./dataset/10yapw/summary.txt', './dataset/10yapw/u_summary.txt')
    # decode('./dataset/10yapw/article.txt', './dataset/10yapw/u_article.txt')

    # specify summary/article path here
    summary_datapath = './dataset1/summarypre.txt'
    article_datapath = './dataset1/articlepre.txt'
    # split_dataset(summary_datapath)
    split_dataset(article_datapath)
